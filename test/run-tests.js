...
if (!html.includes('const VERSION = "v57"')) throw new Error("v57 marker missing");
...
if (!html.includes('{ version: "v57", title: "Quick Booking text cleanup"')) throw new Error('v57 release notes entry missing');
if (!html.includes('{ version: "v56", title: "Quick Booking button placement"')) throw new Error('v56 release notes entry missing');
if (html.includes('Optional simpler view. The normal full-list view is still the default.')) throw new Error('v57 should remove the extra Quick Booking explanatory sentence');
...
console.log("PASS: v57 UI regression checks passed");
