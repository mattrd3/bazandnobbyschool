...
if (!html.includes("v10")) throw new Error("v10 marker missing");
...
console.log("PASS: v10 static dropdown/fallback checks passed");

// v3 static feature/usability checks
const htmlV3 = fs.readFileSync(new URL("../public/index.html", import.meta.url), "utf8");
if (!htmlV3.includes("v10")) throw new Error("v10 marker missing");
...
console.log("PASS: v10 admin WhatsApp/competition usability checks passed");
...
console.log("PASS: v10 booking-window UI checks passed");
...
console.log("PASS: v10 add confirmation UI checks passed");
...
console.log("PASS: v10 locked-date confirmed-player UI checks passed");
...
console.log("PASS: v10 soft sage theme checks passed");
